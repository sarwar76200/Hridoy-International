(function ($) {
    ...
    $(window).on('load', function (event) {
        $('.js-preloader').delay(0).fadeOut(500);
    });
...
function toggleIcon(icon) {
    const btns = document.getElementsByClassName('theme-toggler');
    for (let i = 0; i < btns.length; ++i) {
        btns[i].innerHTML = `<img src="assets/img/icon/${icon}.svg">`;
    }


    // document.getElementById('theme-toggler').innerHTML = `<img src="assets/img/icon/${icon}.svg">`;
}
